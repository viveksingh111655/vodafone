...
/**
 * @author jwheaton
 * @version $Id: //product/Siebel/version/0.6.0.0.0/src/atg/siebel/account/command/CommandInputBean.java#1 $$Change: 842106 $
...
public class CommandInputBean {
  ...
  // Constants
  // -------------------------------------
  public static final String CLASS_VERSION = "$Id: //product/Siebel/version/0.6.0.0.0/src/atg/siebel/account/command/CommandInputBean.java#1 $$Change: 842106 $";
