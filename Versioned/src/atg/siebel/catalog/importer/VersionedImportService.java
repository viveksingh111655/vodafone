...
public class VersionedImportService extends SingleThreadedImportService {
	// -------------------------------------
	public static String CLASS_VERSION = "$Id: //product/Siebel/version/0.6.0.0.0/Versioned/src/atg/siebel/catalog/importer/VersionedImportService.java#1 $$Change: 842106 $";
