 ...
 *
 * @author bbrady
 * @version $Id: //product/Siebel/version/0.6.0.0.0/src/atg/siebel/configurator/ChildProductConfigInstance.java#1 $$Change: 842106 $
...
public class ChildProductConfigInstance extends ProductConfigInstance {
  ...
  public static final String CLASS_VERSION = "$Id: //product/Siebel/version/0.6.0.0.0/src/atg/siebel/configurator/ChildProductConfigInstance.java#1 $$Change: 842106 $";
  ...
  public boolean isConfigurableViaSiebelWebservice() {
    return getConfiguratorManager().getConfiguratorTools()
        .isConfigurableViaSiebelWebservice(getRootInstance().getType(), true);
  }
